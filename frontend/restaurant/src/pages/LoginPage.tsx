  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      const msg =
        ...
        'E-mail ou senha inválidos para este restaurante.'
      setError(msg)
    } finally {
      ...
      <header className="border-b border-zinc-200 dark:border-zinc-800/80 px-6 sm:px-12 py-5 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <span className="text-[11px] font-mono uppercase tracking-widest text-zinc-400 dark:text-zinc-600 hidden sm:inline flex items-center gap-1.5">
            <Store className="w-3.5 h-3.5 text-[#D4B316] dark:text-[#F5DC55]" />
            Portal do Restaurante Parceiro
          </span>
          <ThemeToggle />
        </div>
      </header>
        ...
        <div className="lg:col-span-7 space-y-8">
          <div className="space-y-3">
            <p className="text-[12px] font-mono uppercase tracking-widest text-zinc-400 dark:text-zinc-500">
              Gestão de Restaurante // Painel Operacional
            </p>
            <h1 className="text-4xl sm:text-6xl font-medium tracking-tight text-zinc-950 dark:text-zinc-50 leading-[1.08]">
              Gerencie seu restaurante com máxima precisão.
            </h1>
          </div>

          <p className="text-base sm:text-lg text-zinc-600 dark:text-zinc-400 max-w-xl font-light leading-relaxed">
            Controle de pedidos, sequenciamento de etapas da cozinha, taxas de entrega por bairro ou raio e autonomia completa da sua operação gastronômica.
          </p>

          <div className="pt-6 border-t border-zinc-200 dark:border-zinc-800/80 flex flex-wrap gap-8 text-xs font-mono text-zinc-500 dark:text-zinc-500">
            <div>
              <span className="text-zinc-950 dark:text-zinc-200 font-semibold block text-sm">Site & Delivery Próprio</span>
              <span>Sem comissões por pedido</span>
            </div>
            <div>
              <span className="text-zinc-950 dark:text-zinc-200 font-semibold block text-sm">Tempo Preditivo Real</span>
              <span>Sincronia com a cozinha</span>
            </div>
          </div>
        </div>

        {/* Right Form Column — Zero Cards */}
        <div className="lg:col-span-5 lg:pl-6">
          <div className="space-y-6">
            
            <div className="border-b border-zinc-200 dark:border-zinc-800/80 pb-4">
              <h2 className="text-xl font-medium text-zinc-950 dark:text-zinc-100 tracking-tight">
                Acesso do Gestor
              </h2>
              <p className="text-xs text-zinc-500 dark:text-zinc-400 mt-1 font-mono">
                Entre com seu e-mail cadastrado na Doispalitos.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  className="w-full px-3.5 py-3 bg-transparent border border-zinc-300 dark:border-zinc-800 rounded-lg text-zinc-900 dark:text-zinc-100 placeholder-zinc-400 dark:placeholder-zinc-600 text-sm focus:border-[#F5DC55] dark:focus:border-[#F5DC55] focus:outline-none transition-colors"
                />
              </div>
              ...
              >
                {isSubmitting ? (
                  ...
                  <>
                    <span>Entrar no Restaurante</span>
            ...
            <div className="pt-4 text-[11px] font-mono text-zinc-400 dark:text-zinc-600">
              Acesso seguro, autenticado e criptografado.
            </div>
